...
L["c2/l1"] = {"id": "c2-l1", "capitolo": "Logica", "titolo": "Le variabili", "durata": "6 min", "prossima": "c2-l2", "schede": [
    ...
    sp("Il piano di Bit", ["Due laser con tempi diversi. Crea una variabile per l'attesa e usala due volte: se poi vuoi cambiare i secondi, li cambi in un posto solo.", "La moneta è sul pavimento, un passo davanti a te."]),
...
L["c2/l2"] = {"id": "c2-l2", "capitolo": "Logica", "titolo": "Il se", "durata": "7 min", "prossima": "c2-l3", "schede": [
    ...
    sp("Stanze diverse, stesso programma", ["Da questo livello il tuo programma viene provato in più stanze una dopo l'altra: Bit rientra dall'inizio, in una il laser parte acceso, nell'altra spento.", "Deve funzionare in tutte. Ci riesce solo se decide con if, invece di indovinare i tempi."]),
...
L["c2/l4"] = {"id": "c2-l4", "capitolo": "Logica", "titolo": "Due condizioni", "durata": "7 min", "prossima": "c2-l5", "schede": [
    ...
    scelta("Il laser è spento e davanti non c'è nessun buco. Dove arriva Bit, partendo da x = 0?", ["x = 2", "x = 3", "x = 4"], 1, "Un passo, niente attesa, un altro passo (non c'è il buco), un passo: tre passi in tutto.", "moveRight()\nif (laser.isOn) {\n  wait(3)\n}\nif (frontIsGap()) {\n  jump()\n} else {\n  moveRight()\n}\nmoveRight()"),
...
L["c3/l5"] = {"id": "c3-l5", "capitolo": "Cicli", "titolo": "Il grande salone", "durata": "10 min", "prossima": None, "epilogo": "Capitolo Cicli finito. Da qui in poi nessun programma tuo dovrà più ripetersi: for quando sai quante volte, while quando lo decide il mondo.", "schede": [
    sp("Tutto insieme", ["L'ultima stanza di Bit in questo capitolo: due buchi, un laser, un gradino e una moneta. Nessuna riga uguale ripetuta tre volte di fila: usa i cicli.", "Il programma gira in due stanze diverse: cambiano la posizione dei buchi e il ritmo del laser."], None, MASCOTTE),
