// Scheda di spiegazione: titolo, immagine opzionale, blocco di codice opzionale, paragrafi (con il codice evidenziato dentro al testo).
...
export function render(scheda) {
  ...
  for (const t of scheda.testo || []) { const p = document.createElement('p'); riempi(p, t); el.appendChild(p); }
